...
╠═════════════════════════
║             💠 By : MRWHITETRUEX 💠
║    〽️ line.me/ti/p/~mrwhitetruex 〽️
╚═════════════════════════
"""

botMessage ="""
╔═════════════════════════
║             ☆☞ B O T . N Y A MRWHITETRUEX ☜☆
╠═════════════════════════
╠➩〘Absen〙
╠➩〘Respon〙
╠➩〘Runtime〙
...
╠➩〘Responkick on/off〙
╠➩〘Leave on/off〙
╠➩〘All join / (MRWHITETRUEX1/2/3/4 Join)〙
╠═════════════════════════
║             💠 By : MRWHITETRUEX 💠
║    〽️ line.me/ti/p/~mrwhitetruex 〽️
╚═════════════════════════
...
wait = {
    ...
    'timeline':True,
    "Timeline":True,
    "comment1":"Auto Like ©By : mrwhitetruex\nContact Me : 👉 line.me/ti/p/~mrwhitetruex",
    "comment2":"Auto Like ©By : mrwhitetruex\nContact Me : 👉 line.me/ti/p/~mrwhitetruex",
    "comment3":"Auto Like ©By : mrwhitetruex\nContact Me : 👉 line.me/ti/p/~mrwhitetruex",
    "comment4":"Auto Like ©By : mrwhitetruex\nContact Me : 👉 line.me/ti/p/~mrwhitetruex",
    "comment5":"Auto Like ©By : mrwhitetruex\nContact Me : 👉 line.me/ti/p/~mrwhitetruex",    
    "commentOn":True,
    "commentBlack":{},
...
def bot(op):
    try:
	    ...
	    if mid in op.param3:	        
			...
			G.preventJoinByTicket = True
			cl.updateGroup(G)
			cl.sendText(op.param1,"☆Ketik ☞Help aja bang kalo ga paham tanya mrwhitetruex☜ Untuk Bantuan☆\n☆Pake yang bijak jangan barbar!!! ☆")
        ...
        if op.type == 26:
            ...
            if 'MENTION' in msg.contentMetadata.keys() != None:
                 if wait["detectMention"] == True:
                     contact = cl.getContact(msg.from_)
                     cName = contact.displayName
                     balas = ["Sekali lagi nge tag gw sumpahin jomblo seumur hidup!","Dont Tag!! Lagi BUCIN!!",cName + " Ngapain Ngetag?",cName + " Nggak Usah Tag-Tag! Kalo Penting Langsung Pc Aja","Tag Mulu Lu Anjirr!","Dia Lagi Off", cName + " Kenapa Tag? Kangen?","Dia Lagi Tidur\nJangan Di Tag " + cName, "Jangan Suka Tag Gua " + cName, "Kamu Siapa " + cName + "?", "Ada Perlu Apa " + cName + "?","Woii " + cName + " Jangan Ngetag, Riibut!"]
                     ret_ = random.choice(balas)
                     name = re.findall(r'@(\w+)', msg.text)
                     mention = ast.literal_eval(msg.contentMetadata['MENTION'])
                     mentionees = mention['MENTIONEES']
...
#		else:                    
		...
		cl.sendText(msg.to,"Pasukan Absen!!")
                ki.sendText(msg.to,"MRWHITETRUEX1 Hadiir  \(ˆ▿ˆ)/")
                kk.sendText(msg.to,"MRWHITETRUEX2 Hadiir  \(ˆ▿ˆ)/")
                kc.sendText(msg.to,"MRWHITETRUEX3 Hadiir  \(ˆ▿ˆ)/")
		...
		if msg.from_ in admin:
                    if msg.toType == 2:
                        ...
                        ki.sendText(msg.to,"Blacklist emang pantas buat di usir")
		else:
		...
		if msg.from_ in Creator:
	        ...
	        if msg.from_ in Creator:                
              ...
              if msg.from_ in Creator:
                msg.contentType = 13
                msg.contentMetadata = {'mid': "MRWHITETRUEX,'"}
                cl.sendMessage(msg)
